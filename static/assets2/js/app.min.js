...
! function(t, e) {
    ...
    $.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', W.handleDismiss(new W)), _((function() {
        var t = y();
        if (t) {
            var e = t.fn[N];
        ...
        fn: function(t) {
            ...
            if (!e.modifiersData[n]._skip) {
                for (var o = i.mainAxis, s = void 0 === o || o, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, d = i.boundary, u = i.rootBoundary, h = i.altBoundary, p = i.flipVariations, f = void 0 === p || p, m = i.allowedAutoPlacements, g = e.options.placement, v = ft(g), y = l || (v !== g && f ? function(t) {
                        ...
                        var e = zt(t);
                        return [jt(t), e, jt(e)]
                    }(g) : [zt(g)]), _ = [g].concat(y).reduce((function(t, i) {
                    ...
                    var M = zt(D),
                        z = [];
                    if (s && z.push(A[x] <= 0), a && z.push(A[D] <= 0, A[M] <= 0), z.every((function(t) {
                            return t
                        }))) {
                        C = E, T = !1;
                        break
                ...
                if (k) {
                    if (s) {
                        var x = "y" === b ? et : ot,
                            ...
                            W = H[O],
                            B = Ct(0, T[I], $[I]),
                            R = _ ? T[I] / 2 - M - B - N - S : z - B - N - S,
                            F = _ ? -T[I] / 2 + M + B + W + S : P + B + W + S,
                            ...
                            V = k[b] + R - Y - U,
                            Q = k[b] + F - Y,
                            K = Ct(p ? Math.min(A, V) : A, L, p ? Math.max(D, Q) : D);
                        k[b] = K, E[b] = K - L
                    }
                    if (a) {
                        var X = "x" === b ? et : ot,
    ...
    var oe = ne(),
        se = ne({
            defaultModifiers: [Dt, Zt, Lt, pt]
        }),
        re = ne({
            defaultModifiers: [Dt, Zt, Lt, pt, Gt, Vt, Jt, xt, Xt]
        }),
        ae = Object.freeze({
            __proto__: null,
            popperGenerator: ne,
    ...
    _((function() {
        ...
        if (t) {
            var e = t.fn[ze];
            t.fn[ze] = Ne.jQueryInterface, t.fn[ze].Constructor = Ne, t.fn[ze].noConflict = function() {
                return t.fn[ze] = e, Ne.jQueryInterface
            }
        }
    }));
    var We = "scrollspy",
...
function(t) {
            ...
            getInline: function(i, n) {
                if (I(), i.src) {
                    ...
                    if (s.length) {
                        ...
                        r && r.tagName && (E || (S = o.hiddenClass, E = w(S), S = "mfp-" + S), x = s.after(E).detach().removeClass(S)), e.updateStatus("ready")
    ...
    t.magnificPopup.registerModule(A, {
        ...
        proto: {
            initAjax: function() {
                e.types.push(A), L = e.st.ajax.cursor, b(a + "." + A, M), b("BeforeChange." + A, M)
            },
            getAjax: function(i) {
                ...
                var n = t.extend({
                    ...
                    success: function(n, o, s) {
                        ...
                        k("ParseAjax", r), e.appendContent(t(r.data), A), i.finished = !0, D(), e._setFocus(), setTimeout((function() {
                            e.wrap.addClass(f)
